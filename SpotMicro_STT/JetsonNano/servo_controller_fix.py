...
class Controllers:
    def __init__(self):
        ...
        for i in range(0, 12):
            if i<6:
                self._servos.append(servo.Servo(self._pca_1.channels[i], min_pulse=450, max_pulse=2750))
            else:
                self._servos.append(servo.Servo(self._pca_2.channels[i], min_pulse=450, max_pulse=2750))
        ...
        self._servo_offsets = [167, 80, 95, 48, 80, 100, 150, 40, 90, 35, 72, 102]
        # 다리를 쭉 뻗고 선 모습
